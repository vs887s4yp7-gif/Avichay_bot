...
> = {
  ...
  party_events: {
    ...
    keywords: ["מסיבה", "מסיבות", "למסיבות", "בלון", "בלונים", "יום הולדת", "קישוטי מסיבה", "סטים למסיבה", "סט למסיבה", "סטים", "סט למסיב", "סטים למסיב", "סטים למסיבה", "למסיב"],
    priority: 70,
  },
...
export const INTENT_RULES: Record<Intent, IntentRule> = {
  ...
  order: {
    ...
    keywords: ["תכין לי", "תכין", "הכן לי", "תן לי", "אני רוצה להזמין", "הזמנה", "אני צריך", "תוסיף לי", "תוסיף", "שולח הזמנה", "תארגן לי", "תביא לי",
      ...
      "לוקח", "אני לוקח", "שים", "הרגיל שלי", "הרגיל", "צריך היום", "דחוק", "צריך דחוק", "הרבה מכל סוג", "הרבה מכל"],
  ...
  delivery: {
    intent: "delivery",
    keywords: ["דליברי", "משלוח", "המשלוח", "ומה עם משלוח", "מתי יגיע המשלוח", "מתי יגיע המשלוח הבא", "המשלוח הבא", "מתי מגיע", "מתי יגיע", "כמה זמן לוקח", "שליח", "איסוף",
