...
> = {
  ...
  building_vehicles: {
    ...
    keywords: ["לגו", "קוביות", "הרכבה", "רובוט", "רובוטים", "מכונית", "רכב", "מסוק"],
    priority: 100,
  },
  ...
  summer_decor: {
    ...
    keywords: ["מאוורר", "מניפה", "טחנת רוח", "קישוטי גינה"],
    priority: 50,
  },
...
export const INTENT_RULES: Record<Intent, IntentRule> = {
  ...
  greeting: {
    intent: "greeting",
    keywords: ["היי", "שלום", "בוקר טוב", "ערב טוב", "מה קורה", "מה המצב"],
    priority: 1,
    template: () =>
  ...
  identity: {
    intent: "identity",
    keywords: ["מי אתה", "מי זה", "את מי מדברת", "אתה בוט", "את בוט", "רובוט", "מה השם שלך", "איך קוראים לך", "בינה מלאכותית", "אתה אדם", "מה אתה"],
    priority: 2,
    template: () =>
